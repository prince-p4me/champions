  ...
  return (
    <View >
        <View style={styles.offercontainer}>
          ...
          <Image source={Images.dish} style={{width:130,height:120,borderTopLeftRadius:20,borderBottomLeftRadius:20}}
          ...
          <TouchableOpacity style={{alignSelf: 'flex-end',backgroundColor:Color.theme,height:30,width:120, alignItems:'center', justifyContent: 'center',borderRadius:3,marginLeft:130,marginTop:20}}
      onPress={() => onPress()}>
